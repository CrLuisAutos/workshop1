...
namespace crudasp.Controllers
{
    ...
    {
        private crudaspContext db = new crudaspContext();
        ...
        public ActionResult Create([Bind(Include = "id,nombre,apellido")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,apellido")] Carro carro)
        {
            if (ModelState.IsValid)
            {
